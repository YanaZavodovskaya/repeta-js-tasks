...
// добавляем класс на тэг h1
titleEl.classList.add('page-title');
// добавляем текстовый контент в тэг
...
// создаём новый тэг-элемент img изображение
...
// ==============================добавим еще один элемент в наш список=======================
...
// нам нужно чтобы созданная ссылка была внутри лишки,
...
const navEl = document.querySelector('.site-nav');
// добавляем в этот список созданную лишку со ссылкой
// добавляет в конец
...
const colorPickerOptions = [
    { label: 'red', color: '#d62828' },
    {label: 'green', color: '#06d6a0'},    
    {label: 'blue', color: '#2ec4b6'},
    {label: 'grey', color: '#adb5bd'},
    {label: 'pink', color: '#ffadad'},
    {label: 'indigo', color: '#6411ad'},
]
